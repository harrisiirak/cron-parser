...
var {CronFields} = require('../lib/CronFields');

test('compact field - empty array', function(t) {
  try {
    var result = CronFields.compactField([]);
    t.same(result, []);
  } catch (err) {
...
test('compact field - single element array', function(t) {
  try {
    var result = CronFields.compactField([1]);
    t.same(result, [{
      start: 1,
      count: 1
    }]);
...
test('compact field - 2 elements array', function(t) {
  try {
    var result = CronFields.compactField([1, 2]);
    t.same(result, [
      {
        start: 1,
        count: 1
...
test('compact field - 2 elements array big step', function(t) {
  try {
    var result = CronFields.compactField([1, 5]);
    t.same(result, [
      {
        start: 1,
        count: 1
...
test('compact field - 3 elements array 1 step', function(t) {
  try {
    var result = CronFields.compactField([1, 2, 3]);
    t.same(result, [
      {
        start: 1,
        end: 3,
...
test('compact field - 3 elements array 1 step, dangling extra at end', function(t) {
  try {
    var result = CronFields.compactField([1, 2, 3, 5]);
    t.same(result, [
      {
        start: 1,
        end: 3,
...
test('compact field - 3 elements array 1 step, dangling extra at end and beginning', function(t) {
  try {
    var result = CronFields.compactField([1, 4, 5, 6, 9]);
    t.same(result, [
      {
        start: 1,
        count: 1
...
test('compact field - 2 ranges with dangling in the middle', function(t) {
  try {
    var result = CronFields.compactField([1, 2, 3, 6, 9, 11, 13]);
    t.same(result, [
      {
        start: 1,
        end: 3,
...
test('compact field - with chars', function(t) {
  try {
    var result = CronFields.compactField(['L', 'W']);
    t.same(result, [
      {
        start: 'L',
        count: 1
...
test('compact field - with chars and range', function(t) {
  try {
    var result = CronFields.compactField([1, 'L', 'W']);
    t.same(result, [
      {
        start: 1,
        count: 1,
...
test('compact field - with chars and range (v2)', function(t) {
  try {
    var result = CronFields.compactField([1, 2, 'L', 'W']);
    t.same(result, [
      {
        start: 1,
        count: 1,
...
test('compact field - with chars and range (v3)', function(t) {
  try {
    var result = CronFields.compactField([1, 2, 3, 'L', 'W']);
    t.same(result, [
      {
        start: 1,
        end: 3,
