...
try {
  ...
  console.log('Date: ', interval.previous().toString()); // Sat Dec 29 2012 00:42:00 GMT+0200 (EET)
  console.log('Date: ', interval.previous().toString()); // Sat Dec 29 2012 00:40:00 GMT+0200 (EET)
} catch (err) {
