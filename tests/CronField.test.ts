...
describe('CronFields', () => {
  ...
  describe('CronFieldCollection.compactField', () => {
    ...
    test('2 ranges with dangling in the middle', function () {
    ...
    test('with chars and range', function () {
    ...
    test('with chars and range (v2)', function () {
