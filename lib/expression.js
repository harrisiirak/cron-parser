...
class CronExpression {
  ...
  static _isValidConstraintChar (constraints, value) {
   ...
   * @private
   */
  static _parseField (field, value, constraints) {
    // Replace aliases
    switch (field) {
      case 'month':
      case 'dayOfWeek':
  ...
  static _handleMaxDaysInMonth (mappedFields) {
