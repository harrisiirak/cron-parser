...
/**
 * Wrapper for CronExpression.stringify method
 *
 * @public
 ...
 * @return {String}
 */
CronParser.stringifyExpression = function stringifyExpression (fields, options) {
  return CronExpression.stringify(fields);
};
