 ...
 */
CronParser._parseEntry = function _parseEntry (entry, callback) {
 ...
 * @param {Object} [options] Parsing options
 */
CronParser.parseExpressionSync = function parseExpressionSync (expression, options) {
 ...
 * @param {Function} callback
 */
CronParser.parseString = function parseString (data, callback) {
  var self = this;
  ...
  blocks.forEach(function iterateBlock (entry, index) {
    var matches = null;
